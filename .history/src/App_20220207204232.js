...
function App() {
  ...
  const onSubmit1 = () => {
    ...
    //   condition: condition,
    // });
    // workbook.xlsx.writeFile('./testing.xlsx');
    var row = ["title", "isbn", "isbn13"];
    var filePath = "/testing.xlsx";
    var sheetName = "Sheet1";
    spreadSheet.addRow(row, filePath, sheetName, function (err, result) {});
  };
  const onSubmit = () => {};
  ...
  return (
    <div className="App">
      ...
      />
      <button onClick={onSubmit1}>Submit excel</button>43
    </div>
  );
}
