...
function App() {
  ...
  .then(function (response) {
    ...
    setIsbn(response.data.book.isbn);
  })
  ...
  return (
    ...
    <Select
        ...
        >
          <MenuItem value="Good" onSelect={setCondition("Good")}>Good</MenuItem>
          <MenuItem value="New" onSelect={setCondition("New")} >New</MenuItem>
          <MenuItem value="Like" onSelect={setCondition("Like New")} >Like New </MenuItem>
        </Select>
