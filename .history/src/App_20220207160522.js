...
function App() {
  ...
  const csvData = [
    { name: title , isbn13: isbn13, image: image, authors: authors ,covertype : covertype , weight : weight,price : price , inventory : inventory , location : location , rating : ratings , description, genres : genres , condition : condition  },
  ];
