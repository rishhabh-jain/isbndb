      ...
      <Form
        ...
        render={({ handleSubmit }) => (
          ...
          <Field name="condition" component="select">
            ...
            <Select value={condition} label="Condition" onChange={onConditionChange}>
              <MenuItem value="Good" onSelect={onConditionChange}>Good</MenuItem>
              <MenuItem value="New" onSelect={onConditionChange}>New</MenuItem>
              <MenuItem value="Like New" onSelect={onConditionChange}>Like New </MenuItem>
            </Select>
